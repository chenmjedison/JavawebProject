...
public interface UserDao {
	...
	//用户注册
<<<<<<< HEAD
	@Select("insert into tb_user(userId,userName,userPassword,userSex,userPhone,userAddress,qx_name) values(null,#{userName},#{userPassword},#{userSex},#{userPhone},#{userAddress},#{qx_name})")
=======
