...
public class MultipartFileUtils {
	private static String projectName = "nn-ssm";
	public static final String PRODUCT_IMG_SAVE_PATH="/src/main/webapp/productsImg";
	public static final String PRODUCT_VIDEO_SAVE_PATH="/src/main/webapp/videoImg";
	public static final String CARRENTAL_IMG_SAVE_PATH="/src/main/webapp/carrentalimg";
	...
	public static Map<String, Object> saveFile(HttpServletRequest request,
		...
		String fileName = "product_" + timeStamp + fileNameSuffix.toLowerCase();// 新的图片名称.png
