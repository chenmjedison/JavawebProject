...
<body>
	<form name="form1" method="post" action="findAllWenJuanIndex?currentPage=1"
		 id="form1">
		<div>
				...
				<tr>
					<td valign="top" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><table
							...
							<tr class="font">
								...
								<td width="57%" height="30"><span id="Label6">${sessionScope.user.userId}</span></td>
							</tr>
							<tr class="font">
								...
								<td height="30"><input name="userName" type="text"
									value="${sessionScope.user.userName }" id="userName" /></td>
							</tr>
							<tr class="font">
								<td height="30"><div align="right">
								...
								<td height="30"><input name="userPassword" type="password"
									value="${sessionScope.user.userPassword }" id="userPassword" /></td>
							</tr>
							<tr class="font">
								<td height="30"><div align="right">
								...
								<td height="30"><input name="userSex" type="text"
									value="${sessionScope.user.userSex }" id="userSex" /></td>
							</tr>
							<tr class="font">
								<td height="30"><div align="right">
								...
								<td height="30"><input name="userPhone" type="text"
									value="${sessionScope.user.userPhone }" id="userPhone" /></td>
							</tr>
							<tr class="font">
								<td height="30"><div align="right">
								...
								<td height="30"><input name="userAddress" type="text"
									value="${sessionScope.user.userAddress }" id="userAddress" /></td>
							</tr>
							<tr class="font">
								<td height="30"><div align="right">
								...
								<td height="30"><input name="qx_name" type="text"
									value="${sessionScope.user.qx_name }" id="qx_name" readonly="readonly"/></td>
							</tr>
							<tr>
