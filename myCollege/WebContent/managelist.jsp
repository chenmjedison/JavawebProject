...
<body>
	<form id="form" name="form" action="findManageLikeName?currentPage=1" method="post">
		<div>
				...
				<tr bordercolor="#FFFFFF">
					...
					<td width="85%" valign="top">
						...
						<table width="100%%" border="0">
							<tr>
								<td bgcolor="#CCFFCC" style="width: 580px">管理员信息浏览</td>
							</tr>
							<tr>
								<td bgcolor="#FFFFFF" class="font" style="width: 580px"><span
									id="Label2">请输入想要查询的员工名的关键字:</span> 
									...
									<div>
										<table cellspacing="0" cellpadding="4" border="0"
											...
											<tr
												...
												<th align="center" scope="col" width="15%">员工ID</th>
												<th align="center" scope="col" width="15%">员工名</th>
												
												<th align="center" scope="col" width="15%">员工权限名</th>
												
												<th align="center" scope="col" width="15%">操作</th>
											</tr>
											<c:forEach items="${pageInfo.list }" var="manage">
												<tr
													style="color: black; background-color: write; font-weight: bold;">
													<td align="center"><input type="checkbox"
														name="manageId" id="manageId" value="${manage.manageId}" /></td>
													<td align="center">${manage.manageId}</td>
													<td align="center">${manage.manageName}</td>
													
													<td align="center">${manage.manageQuanXian}</td>
													
													<td align="center"><a
														href=""></a> <a
														href="deleteManageById?manageId=${manage.manageId}" >删除</a></td>
							...
							<tr>
								<td bgcolor="#CCCCCC" class="font"
									style="width: 580px; height: 21px"><div align="center"><a href="manageadd.jsp">添加管理员</a></div></td>
							</tr>
							<tr>
								<td class="font"
