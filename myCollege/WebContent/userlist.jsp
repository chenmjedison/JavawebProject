	...
	function deleteUser(id) {
		if (confirm('确认删除?')) {
			if (id != undefined) { //如果有id则删除单个
				alert(id);
				window.location = "deleteUserById?userId="+id ;
				alert("333");
...
<body>
	<form id="form" name="form" action="findUserLikeName?currentPage=1"
		method="post">
		<div></div>
				...
				<tr bordercolor="#FFFFFF">
					...
					<td width="85%" valign="top">
						...
						<table width="100%%" border="0">
							<tr>
								<td bgcolor="#CCFFCC" style="width: 580px">用户信息浏览</td>
							</tr>
							<tr>
								<td bgcolor="#FFFFFF" class="font" style="width: 580px"><span
									id="Label2">请输入想要查询的用户名关键字:</span> <input type="text"
									id="checkName" name="checkName" /> <input type="submit"
									value="确认查询" /> </td>
							</tr>
							<tr>
									...
									<div>
										<table cellspacing="0" cellpadding="4" border="0"
											...
											<tr
												...
												<th align="center" scope="col" width="10%">用户ID</th>
												<th align="center" scope="col" width="10%">用户名</th>
												
												<th align="center" scope="col" width="10%">用户性别</th>
												<th align="center" scope="col" width="13%">用户电话号码</th>
												<th align="center" scope="col" width="10%">用户地址</th>
												<th align="center" scope="col" width="15%">用户权限</th>
											...
											<c:forEach items="${pageInfo.list }" var="user">
												<tr
													...
													<td align="center"><input type="checkbox"
														name="userId" id="userId" value="${user.userId}" /></td>
													<td align="center">${user.userId}</td>
													<td align="center">${user.userName}</td>
													<td align="center">${user.userSex}</td>
													<td align="center">${user.userPhone}</td>
													<td align="center">${user.userAddress}</td>
													<td align="center">${user.qx_name}</td>
													<td align="center"><a href="findUserById?userId=${user.userId }">修改</a> <a href="deleteUserById?userId=${user.userId }"
														>删除</a></td>
											...
											<tr><td colspan="7" align="right"><page:pager url="${url}"
